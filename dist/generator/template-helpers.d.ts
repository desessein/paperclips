...
export declare const makeHelpers: ({ connectDtoPrefix, createDtoPrefix, updateDtoPrefix, dtoSuffix, entityPrefix, entitySuffix, transformClassNameCase, transformFileNameCase, classValidation, outputType, noDependencies, }: MakeHelpersParam) => {
    config: {
        connectDtoPrefix: string;
        createDtoPrefix: string;
        updateDtoPrefix: string;
    ...
    fieldsToDtoProps: (fields: ParsedField[], useInputTypes?: boolean, forceOptional?: boolean, annotateAllProps?: boolean) => string;
    fieldToDtoProp: (field: ParsedField, useInputTypes?: boolean, forceOptional?: boolean, annotateAllProps?: boolean) => string;
